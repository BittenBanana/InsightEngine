...
//            gameObject7.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.corner, 2f);
//            gameObject8.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.straight_rotated, 2f);
//            gameObject9.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.wall5x5withDoor, 2f);
//            triggerObject.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.triggerbox, 1f);
//            bulletDispenser.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.bulletdispenser, 1f);
//            dispenserTrigger.GetComponent<MeshRenderer>().Load(content, ContentModels.Instance.dispensertrigger, 1f);
